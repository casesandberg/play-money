...
const DropdownMenuContent = React.forwardRef<
  ...
  React.ComponentPropsWithoutRef<typeof DropdownMenuPrimitive.Content> & { variant?: 'default' | 'ghost' }
>(({ className, variant = 'default', sideOffset = 4, ...props }, ref) => (
  <DropdownMenuPrimitive.Portal>
    <DropdownMenuPrimitive.Content
      className={cn(
        variant === 'default' && 'overflow-hidden rounded-md border bg-popover p-1 text-popover-foreground shadow-md',

// Source: https://github.com/mxkaske/mxkaske.dev/blob/main/hooks/use-update-search-params.ts
...
export default function useUpdateSearchParams() {
  ...
  const update = React.useCallback(
    (params: Record<string, unknown>, opts?: { override: boolean }) => {
      const newSearchParams = new URLSearchParams(opts?.override ? undefined : searchParams.toString())
